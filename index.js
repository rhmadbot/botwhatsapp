...
conn.sendMessage(id, 'Loha' ,MessageType.text);
}
else if (text == '#owner'){
conn.sendMessage(id, 'Owner ঔৣ͜͡R•ঔৣ͜͡MBOT wa.me/+6288245621406' ,MessageType.text);
}
else if (text == 'Rahmad'){
...
conn.sendMessage(id, 'Tayo' ,MessageType.text);
}
else if (text == 'Min'){
...
conn.sendMessage(id, 'uut' ,MessageType.text);
}
